...
Promise.all([
  d3.json(
    "https://raw.githubusercontent.com/Yunado/narrative-viz-video-game-sales/main/110m_modified.json"
  ),
  ...
  function updateYearRange() {
    ...
    const salesData = filteredCSVData.filter(
    ...
    const totalGlobalSales = d3
      .sum(salesData, (d) => +d.Global_Sales)
      .toFixed(2);
